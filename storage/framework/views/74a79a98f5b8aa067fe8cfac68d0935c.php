...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Daftar Kelas & Jurusan')); ?>
...
<?php endif; ?>
                                ...
                                <div class="ml-3">
                                    <a href="<?php echo e(route('grade.create')); ?>"
                                ...
                                <table class="min-w-full w-full">
                                    ...
                                    <?php $__currentLoopData = $grades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $grade): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="border-b">
                                            ...
                                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                <?php echo e($grade->skill_competency); ?>
                                            ...
                                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                <form action="<?php echo e(route('grade.destroy', $grade->id)); ?>" method="post">
                                                    ...
                                                    <div class="flex">
                                                        <a href="<?php echo e(route('grade.edit', $grade->id)); ?>"
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\aplikasi-pembayaran-spp-main\resources\views/pages/grade/index.blade.php ENDPATH**/ ?>