...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Daftar Siswa SMKS BRAHARI')); ?>
                                ...
                                <table class="min-w-full w-full">
                                    ...
                                    <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="border-b">
                                            ...
                                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                <form action="<?php echo e(route('student.destroy', $student->nisn)); ?>" method="post">
                                                    <?php echo csrf_field(); ?>
                                                    <?php echo method_field('DELETE'); ?>
                                                    <div class="flex">
                                                        <a href="<?php echo e(route('student.edit', $student->nisn)); ?>"
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\aplikasi-pembayaran-spp-main\resources\views/pages/student/index.blade.php ENDPATH**/ ?>