<section class="space-y-6">
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            <?php echo e(__('Sekali akun Anda dihapus, semua data yang berhubungan dengan akun Anda juga akan dihapus secara permanen.')); ?>
...
<?php $component->withAttributes(['name' => 'confirm-user-deletion','show' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->userDeletion->isNotEmpty()),'focusable' => true]); ?>
        <form method="post" action="<?php echo e(route('profile.destroy')); ?>" class="p-6">
            ...
            <h2 class="text-lg font-medium text-gray-900">
                <?php echo e(__('Anda yakin ingin menghapus akun Anda?')); ?>
...
<?php /**PATH C:\xampp\htdocs\aplikasi-pembayaran-spp-main\resources\views/profile/partials/delete-user-form.blade.php ENDPATH**/ ?>